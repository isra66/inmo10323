...
<div class="container-fluid">
  <a class="navbar-brand navbar" href="admin.php"><img src="logoLogin.png" style="width: 100px;"> </a>
...
if(isset($_POST['titulo']) && isset($_POST['contenido'])) {
    ...
    if(isset($_FILES['imagen'])) {
        ...
        move_uploaded_file($_FILES['imagen']['tmp_name'], $ruta_imagen);//muevo la carpeta a imaganes
    }
    ...
    <tbody>
        <?php
            ...
            while($fila = mysqli_fetch_assoc($result)) 
            {
                ...
                echo "<a class='btn btn-primary mx-3' href='editar.php?id=" . $fila['id'] . "'>Editar</a>";
