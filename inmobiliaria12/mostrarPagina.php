...
while($fila = mysqli_fetch_assoc($resultado)) {
    ...
    if(!empty($imagen_ruta)) {
        ...
        $html_imagen .="<div class='card text-center'>";
        $html_imagen .= "<img class='card-header' src='$imagen_ruta'>";
        $html_imagen .= "<div class='card-body'>";
        $html_imagen .= "<h5 class='card-title'>$titulo</h5>";
        $html_imagen .= "<p class='card-text'>$contenido</p>";
        $html_imagen .= "<a href='#' class='btn btn-primary'>visitar</a>";
        $html_imagen .= "</div>";
        $html_imagen .= "<div class='card-footer text-muted'>";
        $html_imagen .= "Ahora mismo";
        $html_imagen .= "</div></div>";
        $html_imagen .= "</div>";
    }
...
<body>
          ...
          <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
              <a class="navbar-brand navbar" href="mostrarPagina.php"><img src="logoLogin.png" style="width: 100px;"> </a>
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link  navbarT" href="login.php"><button type="button" class="btn btn-dark">cerrar sesion</button></a>
                  </li>
                </ul>
          ...
          <div class="row">
            <div class="col-4 mt-4">
              ...
              <div class="card text-center">
                <div class="card-header">
                  <img src="/inmobiliaria12/1.jpg" style="width:100% ; height:365px">
                </div>
                <div class="card-body">
                  <h5 class="card-title">Casa Rural</h5>
            ...
            <div class="col-4 mt-4">
              <div class="card text-center">
                <div class="card-header">
                <img src="/inmobiliaria12/2.jpg" style="width:100% ; height:365px">
                </div>
                <div class="card-body">
                  <h5 class="card-title">Piso Planta Baja</h5>
                  <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
            ...
            <div class="col-4 mt-4">
              <div class="card text-center">
                <div class="card-header">
                <img src="/inmobiliaria12/3.jpg" style="width:100%; height:365px">
                </div>
                <div class="card-body">
                  <h5 class="card-title">Adosado en la playa</h5>
                  <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                  <a href="#" class="btn btn-primary">visitar</a>
                </div>
                <div class="card-footer text-muted">
          ...
          <div class="row">
            <div class="col-4 mt-4">
              ...
              <div class="card text-center">
                <div class="card-header">
                <img src="/inmobiliaria12/4.jpg" style="width:100%; height:365px">
                </div>
                <div class="card-body">
                  <h5 class="card-title">Piso Universitario</h5>
                  <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                  <a href="#" class="btn btn-primary">visitar</a>
                </div>
                <div class="card-footer text-muted">
            ...
            <div class="col-4 mt-4">
              <div class="card text-center">
                <div class="card-header">
                <img src="/inmobiliaria12/5.jpg" style="width:100%; height:365px">
                </div>
                <div class="card-body">
            ...
            <div class="col-4 mt-4">
              <div class="card text-center">
                <div class="card-header">
                <img src="/inmobiliaria12/6.jpg" style="width:100%; height:365px">
                </div>
                <div class="card-body">
                  <h5 class="card-title">Casa Rural</h5>
                  <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
...
<div class="c">
  ...
  <section class="hero-section">
    <div class="card-grid">
      <a class="card" href="#">
        <div class="card__background" style="background-image: url(/carta2)"></div>
        <div class="card__content">
          
        </div>
      </a>
      <a class="card" href="#">
        <div class="card__background" style="background-image: url(/carta1)"></div>
        <div class="card__content">
          
        </div>
      </a>
      <a class="card" href="#">
        <div class="card__background" style="background-image: url(/carta3)"></div>
        <div class="card__content">
      ...
      <a class="card" href="#">
        <div class="card__background" style="background-image: url(inmobiliaria12/carta4)"></div>
        <div class="card__content">
